...
$(function() {
  ...
  { 
    action: 'type',
    strings: ["ls -la"],
    output: '<span class="gray">secret &nbsp;&nbsp; <i class="fa fa-heart"></i> RTO (Request Time Out) <i class="fa fa-heart"></i></span><br>&nbsp;',
    postDelay: 1500
  },
  { 
    action: 'type',
  ...
  { 
    action: 'type',
    strings: ["Let's Work And Collaboration : hello@reza.cloud"],
    postDelay: 2000
  }
